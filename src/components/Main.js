            ...
            <div ref={this.props.setWrapperRef}
                ...
                <article id="work"
                    ...
                    <span className="image main">
                        ...
                        <iframe width="100%"
                                ...
                                frameBorder="no"
                                allow="autoplay"
                                src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/649854215&color=%23050505&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
                ...
                <article id="contact"
                    ...
                    <form method="POST"
                        ...
                        <p style={{display: 'none'}}><label>Don’t fill this out if you're human:<input
